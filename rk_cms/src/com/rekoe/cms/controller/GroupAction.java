...
import com.rekoe.cms.model.Group;
...
public class GroupAction extends BaseAction {
	...
	@At("/admin/group/add")
	@Ok("json")
	public String add(@Param("::group.") Group group,
	...
	public String del(@Param("id") int id, @Param("currentPage") int currentPage) {
		...
		if (maxPage > 1) {
			List<Group> groups = basicDao.searchByPage(Group.class,
	...
	public View list(@Param("currentPage") int currentPage,
		...
		List<Group> result = basicDao.searchByPage(Group.class, currentPage,
				SystemContext.PAGE_SIZE, "sortNumber");
		int count = basicDao.searchCount(Group.class);
