...
import com.rekoe.cms.utils.DateConvertUtil;
...
public class AdminAction {
	...
	public View login(	@Param("username") String username,
		...
		if (m != null && m.isState()) {
			...
			return new ViewWrapper(new FreemarkerView("/freemarker/admin/main.html"), m);
		} else {
			if (m == null) {
	...
	@Authority(module=13, action=15,desc="修改密码")
	...
	@Ok("json")
	@Authority(module=14, action=15,desc="修改密码")
